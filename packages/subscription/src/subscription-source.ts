...
export type SubscriptionSource<T,TReturn = undefined> = Subscribable<T,TReturn> | Operation<Subscription<T,TReturn>> | Operation<ChainableSubscription<T,TReturn>>;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function isSubscribable<T,TReturn = undefined>(value: any): value is Subscribable<T,TReturn> {
  return !!value[SymbolSubscribable];
}

export function rawSubscribe<T, TReturn = undefined>(source: SubscriptionSource<T,TReturn>): Operation<Subscription<T,TReturn>> {
