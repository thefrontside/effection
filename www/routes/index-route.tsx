          ...
          <section class="my-20">
            <hgroup class="mx-auto max-w-2xl lg:text-center">
              ...
              <p class="mt-6 text-lg leading-8 text-gray-600">
                ...
                . We ensure that all asyncronous operations are well behaved so
                you can focus on using async instead of managing it.
              </p>
            </hgroup>
          ...
          <section class="mt-20">
            <hgroup class="mx-auto max-w-2xl lg:text-center">
              ...
              <p class="mt-6 text-lg leading-8 text-gray-600">
                ...
                with Structured Concurrency guarantees. It only requires adding
                a few new JavaScript techniques to the knowledge you already
                have.
              </p>
            </hgroup>
            <div class="mx-auto mt-8 max-w-2xl sm:mt-12 lg:mt-16 lg:max-w-4xl md:grid md:grid-cols-2 md:gap-y-4">
