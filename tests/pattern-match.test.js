...
import { patternMatch, any } from '../src/pattern-match';
...
describe('Pattern Match', () => {
  ...
  describe('with predicate function', () => {
    let match = patternMatch((value) => value % 2 === 0);
  ...
  describe('with array where values are matchers', () => {
    let match = patternMatch([{ some: "object" }, (val) => val === 2]);
  ...
  describe('with simple object', () => {
    let match = patternMatch({ some: "object", and: 123 });
  ...
  describe('with object where values are pattern matchers', () => {
    let match = patternMatch({ some: (val) => val === 2, thing: [1] });
  ...
  describe('with any matcher with type', () => {
    let match = patternMatch(any("string"));
  ...
  describe('with any matcher with array', () => {
    let match = patternMatch(any("array"));
