...
import { toc } from "npm:@jsdevtools/rehype-toc@3.0.2";
...
export default function* (doc: Doc): Operation<JSX.Element> {
  ...
  return (
    <section class="mx-auto md:pt-8 w-full justify-items-normal md:grid md:grid-cols-[275px_auto] lg:grid-cols-[275px_auto_200px] md:gap-4">
          ...
          <Rehype
            plugins={[
              ...
              [
                ...
                {
                  cssClasses: {
                    toc: "hidden text-sm font-light tracking-wide leading-loose lg:block relative whitespace-nowrap",
                    list: "fixed",
                  },
                },
              ],
...
function liftTOC(element: JSX.Element): JSX.Element {
  ...
  let nav = element.children.find(
    (child) => child.type === "element" && child.tagName === "nav"
  );
  if (!nav) {
    return element;
  }
