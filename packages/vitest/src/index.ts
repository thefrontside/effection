...
import type { SuiteHooks, TestContext, Suite, File } from 'vitest';
...
function runInAllScope(fn: Suite | File, name: string) {
...
function runInEachScope(fn: TestContext, name: string) {
  return async function (this: TestContext) {
